...
# Stolen from https://gist.github.com/schacon/e9e743dee2e92db9a464619b99e94eff
# Thanks to Scott Chacon

# After installing it, remember to run:
# git config --global alias.bbranch '!better-git-branch.sh'
